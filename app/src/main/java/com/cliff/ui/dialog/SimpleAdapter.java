...
public class SimpleAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            if (isGrid) {
                view = layoutInflater.inflate(R.layout.dialogplus_grid_item, parent, false);
            } else {
