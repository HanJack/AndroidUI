...
public class ViewGroupExample extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.cf_layout_inflate_example);
    ...
    private static class ViewGroupExampleAdapter extends FancyCoverFlowAdapter {
        ...
        private int[] images = {R.drawable.guide01, R.drawable.guide02,
                R.drawable.guide03, R.drawable.guide01, R.drawable.guide02,
                R.drawable.guide03};
