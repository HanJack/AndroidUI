package com.hsj.libdatetime.view;

import android.view.View;

import com.hsj.libdatetime.view.animation.AnimatorProxy;


public final class ViewHelper {
    private static final boolean NEEDS_PROXY  = AnimatorProxy.NEEDS_PROXY;

    private ViewHelper() {}

    public static float getAlpha(View view) {
        return NEEDS_PROXY ? AnimatorProxy.wrap(view).getAlpha() : Honeycomb.getAlpha(view);
    }
    ...
    public static float getPivotX(View view) {
        return NEEDS_PROXY ? AnimatorProxy.wrap(view).getPivotX() : Honeycomb.getPivotX(view);
    }
    ...
    public static float getPivotY(View view) {
        return NEEDS_PROXY ? AnimatorProxy.wrap(view).getPivotY() : Honeycomb.getPivotY(view);
    }
    ...
    public static float getRotation(View view) {
        return NEEDS_PROXY ? AnimatorProxy.wrap(view).getRotation() : Honeycomb.getRotation(view);
    }
    ...
    public static float getRotationX(View view) {
        return NEEDS_PROXY ? AnimatorProxy.wrap(view).getRotationX() : Honeycomb.getRotationX(view);
    }
    ...
    public static float getRotationY(View view) {
        return NEEDS_PROXY ? AnimatorProxy.wrap(view).getRotationY() : Honeycomb.getRotationY(view);
    }
    ...
    public static float getScaleX(View view) {
        return NEEDS_PROXY ? AnimatorProxy.wrap(view).getScaleX() : Honeycomb.getScaleX(view);
    }
    ...
    public static float getScaleY(View view) {
        return NEEDS_PROXY ? AnimatorProxy.wrap(view).getScaleY() : Honeycomb.getScaleY(view);
    }
